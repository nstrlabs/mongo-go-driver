...
<p align="center">
  <a href="https://goreportcard.com/report/github.com/nstrlabs/mongo-go-driver/v2"><img src="https://goreportcard.com/badge/github.com/nstrlabs/mongo-go-driver/v2"></a>
  <a href="https://pkg.go.dev/github.com/nstrlabs/mongo-go-driver/v2/mongo"><img src="etc/assets/godev-mongo-blue.svg" alt="docs"></a>
  <a href="https://pkg.go.dev/github.com/nstrlabs/mongo-go-driver/v2/bson"><img src="etc/assets/godev-bson-blue.svg" alt="docs"></a>
...
```bash
go get github.com/nstrlabs/mongo-go-driver/v2/mongo
```

When using a version of Go that does not support modules, the driver can be installed using `dep` by running

```bash
dep ensure -add "github.com/nstrlabs/mongo-go-driver/v2/mongo"
```
...
For more advanced configuration and authentication, see the [documentation for mongo.Connect](https://pkg.go.dev/github.com/nstrlabs/mongo-go-driver/v2/mongo#Connect).
...
To use `bson.D`, you will need to add `"github.com/nstrlabs/mongo-go-driver/v2/bson"` to your imports.
...
Compression can be enabled using the `compressors` parameter on the connection string or by using [`ClientOptions.SetCompressors`](https://pkg.go.dev/github.com/nstrlabs/mongo-go-driver/mongo/options#ClientOptions.SetCompressors):
